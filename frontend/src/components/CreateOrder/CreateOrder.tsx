        ...
        <FormProvider {...methods}>
            <Form className={"p-2 d-flex flex-column h-100"} onSubmit={methods.handleSubmit(onSubmit)}>
                <Form.Group className="mb-3" controlId="orderCreateCustomer">
                    <Form.Label className={"ms-2 fw-bold"}>Покупатель</Form.Label>
                ...
                <Form.Group className="mb-3" controlId="orderCreateDate">
                    <Form.Label className={"ms-2 fw-bold"}>Дата заказа</Form.Label>
                    <Form.Control
                        type="date"
                ...
                <CreateProducts
                    ...
                    remove={remove}
                />
                <Button style={{ background: "#3E5F8A", color: "#FFF", border: "none" }} className={"button-dark-green-hover"} type="submit">
                    Создать заказ
                </Button>
            </Form>
        </FormProvider>
